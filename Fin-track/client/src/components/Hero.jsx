  ...
  return (
    <section className="flex flex-col items-center justify-center text-center py-20 bg-gray-50">
      <h1 className="text-5xl font-bold text-gray-800 mb-6">
        Manage Your Portfolio with <span className="text-blue-900">FinTrack</span>
      </h1>
      <p className="text-lg text-gray-600 max-w-2xl mb-8">
        Track your investments, monitor market trends, and stay ahead with real-time updates.
      </p>
